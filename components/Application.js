  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.title}>My Car Service 5.1.3</Text>
        <Text style={styles.paragraph}>
          ...
          Προσθέστε όλα σας τα οχήματα και τα αγαπημένα σας συνεργεία επισκευής και αποθηκεύστε τα στην εφαρμογή. Δημιουργήστε το προφίλ σας και φτιάξτε αντίγραφα ασφαλείας όλων των δεδομένων σας στους cloud Server μας για να τις συγχρονίσετε με όλες τις συσκευές σας.
        </Text>
      </View>
    </ScrollView>
  );
